        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-dark/90 via-dark/40 to-transparent p-12 flex flex-col justify-between">
            <div>
              ...
              <div className="flex gap-4 mt-4 text-[10px] tracking-[0.2em] text-muted font-semibold uppercase">
            ...
            <div className="bg-soft/60 backdrop-blur-md border border-white/10 p-6 rounded-sm w-fit mt-12">
              <span className="text-sec text-[10px] tracking-widest uppercase font-bold">
                New Season
              </span>
              <p className="text-navcolor text-sm mt-1 tracking-wider uppercase">
                Archive Series 01
              </p>
            </div>
          </div>
          ...
          <form className="space-y-6">
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full bg-transparent border-b border-bordercolor py-2 outline-none focus:border-pri transition-colors placeholder:text-soft text-sm"
              />
            </div>
